...
template_dir = op.join(op.expanduser("~"), "AFQ_data/SLF_ROIs/")
...
bundles = abd.BundleDict(
    {
        "L_SLF1": {
            ...
            "exclude": [template_dir + "SLFt_roi2_L.nii.gz"],
            "cross_midline": False,
            "mahal": {
                "clean_rounds": 20,
                "length_threshold": 4,
        ...
        "L_SLF2": {
            "include": [template_dir + "MFgL.nii.gz", template_dir + "PaL.nii.gz"],
            "exclude": [template_dir + "SLFt_roi2_L.nii.gz"],
            "cross_midline": False,
            "mahal": {
                "clean_rounds": 20,
        ...
        "L_SLF3": {
            "include": [template_dir + "PrgL.nii.gz", template_dir + "PaL.nii.gz"],
            "exclude": [template_dir + "SLFt_roi2_L.nii.gz"],
            "cross_midline": False,
            "mahal": {
                "clean_rounds": 20,
...
# of images of a particular bundle across a group of participants. In the
# montage function the first input refers to a key in the bundlediect and the
...
montage = my_afq.group_montage("L_SLF3", (3, 4), "Sagittal", "left", slice_pos=0.5)
