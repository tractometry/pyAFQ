...
pyAFQ is an open-source software project. This means that you are welcome to use
it (see `LICENSE <https://github.com/tractometry/pyAFQ/blob/master/LICENSE>`_
for details).
...
<https://github.com/tractometry/pyAFQ/blob/master/.github/CONTRIBUTING.md>`_.
