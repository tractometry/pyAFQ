...
def wm_gm_interface(pve_internal, data_imap):
    ...
    return wmgmi_img, {"FromPVE": pve_internal}
...
def pve_internal(structural_imap, pve="synthseg"):
    ...
    if isinstance(pve, str):
        if pve == "synthseg":
            ...
            return nib.Nifti1Image(PVE, synthseg_seg.affine), {
            ...
            return nib.Nifti1Image(PVE, t1_subcortex_img.affine), {
...
def msmt_apm(msmtcsd_params):
    ...
    return pmap, {"MSMTCSDParamsFile": msmtcsd_params}
...
def msmt_aodf(msmtcsd_params, data_imap):
    ...
    return aodf, {"MSMTCSDParamsFile": msmtcsd_params, "Sphere": "repulsion724"}
...
def msmt_aodf_asi(msmt_aodf_params, data_imap):
    ...
    return asi, {"MSMTCSDParamsFile": msmt_aodf_params}
...
def msmt_aodf_opm(msmt_aodf_params, data_imap):
    ...
    return opm, {"MSMTCSDParamsFile": msmt_aodf_params}
...
def msmt_aodf_nufid(msmt_aodf_params, data_imap, pve_internal):
    ...
    return nufid, {"MSMTCSDParamsFile": msmt_aodf_params, "PVE": pve_internal}
...
def csd_aodf_nufid(data_imap, pve_internal):
    ...
    return nufid, {"CSDParamsFile": data_imap["csd_aodf_params"], "PVE": pve_internal}
